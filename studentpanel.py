...
class Student:
    def __init__(self, root):
        ...
        title_lbl = Label(self.root, text="STUDENT PANEL", font=("times new roman", 18, "bold"), bg="#A52A2A", fg="#DEB887")
        title_lbl.place(x=0, y=100, width=1530, height=45)

        # Create the main frame
        self.main_frame = Frame(self.root, bg="white", bd=2)
        self.main_frame.place(x=375, y=170, width=780, height=520)
        
        # Left label frame
        Left_frame = LabelFrame(self.main_frame, bd=2, bg="white", relief=RIDGE, text="Student Details Form", font=("times new roman", 20, "bold"))
        Left_frame.place(x=20, y=10, width=730, height=500)
        ...
        take_photo_btn = Button(
            btn_frame,command=self.generate_dataset,
            text="Take Photo Sample",
            width=35,
            font=("times new roman", 13, "bold"),
            bg="blue",
