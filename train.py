...
class Train:
    def __init__(self, root):
        ...
        title_lbl = Label(self.root, text="TRAIN DATA SET", font=("times new roman", 35, "bold"), bg="#DB7093", fg="blue")
        title_lbl.place(x=0, y=0, width=1530, height=45)

        img_top = Image.open(r"C:\Users\DELL\Desktop\newFace Recognition, Student Attendance System\images\traindata top.jpg")
        ...
        img_bottom = Image.open(r"C:\Users\DELL\Desktop\newFace Recognition, Student Attendance System\images\traindata bottom.jpg")
